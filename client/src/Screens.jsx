...
import { ButtonPanel,StartForm,PlayAgainPanel } from './Button'
...
const SignInScreen =({ clickStart, flashMessage })=>{
    return (
        <FortySixtyGrid>
          <FullWidthDiv spacer>
            <Banner full={true}/>
...
const WinScreen = ({lang, clickPlayAgain, clickQuit, flashMessage}) => {
  return (
    <FortySixtyGrid>
        <FullWidthDiv>
            <Banner full={false}/>
...
const LoseScreen=({usage, blanks, flashMessage, lang, clickPlayAgain, clickQuit})=>{
    return (
...
const PlayScreen=({ usage, blanks, usedLetters, numBadGuesses, onGuess, flashMessage })=>{
    return (
        <FortySixtyGrid>
          <FullWidthDiv>
            <Banner full={false}/>
